...
public class HttpAsyncClient {
    ...
    public void init() {
        ...
        PoolingNHttpClientConnectionManager connManager = new PoolingNHttpClientConnectionManager(ioReactor, null, sessionStrategyRegistry, (SocketAddressResolver<HttpRoute>) null);
